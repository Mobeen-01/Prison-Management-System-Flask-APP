...
def Product():
   ...
   rows = cur.fetchall();
   return  render_template('Prisoner.html',rows = rows)
...
def ProductMovement():
   ...
   return render_template('PrisonerMovement.html',rows = rows,  productRows =  productRows, locationRows = locationRows)
